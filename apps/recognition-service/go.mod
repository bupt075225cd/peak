...
replace (
	...
	peak/libs/domain => ../../libs/domain
	peak/libs/errors => ../../libs/errors
	peak/libs/http => ../../libs/http
	peak/libs/logger => ../../libs/logger
	peak/libs/observability => ../../libs/observability
	peak/libs/storage => ../../libs/storage
)
